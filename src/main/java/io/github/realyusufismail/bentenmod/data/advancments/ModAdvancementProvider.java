...
import io.github.realyusufismail.bentenmod.core.util.NameUtils;
...
public class ModAdvancementProvider implements IDataProvider {
    ...
    private static class Advancements implements Consumer<Consumer<Advancement>> {
        private static Advancement simpleGetItem(
                Consumer<Advancement> consumer, IItemProvider item, Advancement parent) {
            return simpleGetItem(
                    consumer, item, parent, NameUtils.fromItem(item).getPath());
        }

        private static Advancement simpleGetItem(
                Consumer<Advancement> consumer, IItemProvider item, Advancement parent, String key) {
            return simpleGetItem(consumer, item, new ItemStack(item), parent, key);
        }

        private static Advancement simpleGetItem(
                Consumer<Advancement> consumer, IItemProvider item, ItemStack icon, Advancement parent, String key) {
        ...
        public void accept(Consumer<Advancement> consumer) {
            ...
            Advancement black_diamond_scrap = Advancement.Builder.advancement()
                    .parent(root)
                    .display(
                            BLACK_DIAMOND_SCRAP.get(),
                            title("black_diamond_scrap"),
            ...
            Advancement black_diamond_armour = Advancement.Builder.advancement()
                    ...
                    .display(
                            BLACK_DIAMOND_CHESTPLATE.get(),
                            title("black_diamond_armour"),
            ...
            Advancement black_diamond_tools = Advancement.Builder.advancement()
                    .parent(black_diamond_ingot)
                    .display(
                            BLACK_DIAMOND_SWORD.get(),
                            title("black_diamond_tools"),
            ...
            Advancement heatblast_armour = Advancement.Builder.advancement()
                    .parent(fire_ingot)
                    .display(
                            HEATBLAST_CHESTPLATE.get(),
                            title("heatblast_armour"),
            ...
            Advancement omnitrix_block = Advancement.Builder.advancement()
                    ...
                    .display(
                            BlockInit.OMNITRIX_BLOCK.get(),
                            title("omnitrix_block"),
            ...
            Advancement imperium_block = Advancement.Builder.advancement()
                    ...
                    .display(
                            BlockInit.IMPERIUM_BLOCK.get(),
                            title("imperium_block"),
            ...
            Advancement upgraded_imperium_pickaxe = Advancement.Builder.advancement()
                    ...
                    .display(
                            ...
                            title("upgraded_imperium_pickaxe"),
            ...
            Advancement legendary_block = Advancement.Builder.advancement()
                    ...
                    .display(
                            BlockInit.LEGENDARY_BLOCK.get(),
                            title("legendary_block"),
            ...
            Advancement infinitum_block = Advancement.Builder.advancement()
                    ...
                    .display(
                            BlockInit.INFINITUM_BLOCK.get(),
                            title("infinitum_block"),
            ...
            Advancement infinitum_armour = Advancement.Builder.advancement()
                    .parent(infinitum_ingot)
                    .display(
                            INFINITUM_CHESTPLATE.get(),
                            title("infinitum_armour"),
