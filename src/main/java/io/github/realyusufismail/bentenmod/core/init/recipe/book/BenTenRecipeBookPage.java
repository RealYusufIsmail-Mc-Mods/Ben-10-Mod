...
import io.github.realyusufismail.bentenmod.core.init.recipe.BenTenOverlayRecipeComponent;
...
@OnlyIn(Dist.CLIENT)
public class BenTenRecipeBookPage {
    public static final int ITEMS_PER_PAGE = 20;
    private final List<BenTenRecipeButton> buttons = Lists.newArrayListWithCapacity(20);
    @Nullable
    private BenTenRecipeButton hoveredButton;
    private final BenTenOverlayRecipeComponent overlay = new BenTenOverlayRecipeComponent();
    private Minecraft minecraft;
    private final List<RecipeShownListener> showListeners = Lists.newArrayList();
    private List<BenTenRecipeCollection> recipeCollections = ImmutableList.of();
    ...
    @Nullable
    private BenTenRecipeCollection lastClickedRecipeCollection;
    ...
    public void updateCollections(List<BenTenRecipeCollection> pRecipeCollections,
            boolean p_100438_) {
    ...
    private void updateButtonsForPage() {
        ...
        for (int j = 0; j < this.buttons.size(); ++j) {
            ...
            if (i + j < this.recipeCollections.size()) {
                BenTenRecipeCollection recipecollection = this.recipeCollections.get(i + j);
    ...
    @Nullable
    public BenTenRecipeCollection getLastClickedRecipeCollection() {
