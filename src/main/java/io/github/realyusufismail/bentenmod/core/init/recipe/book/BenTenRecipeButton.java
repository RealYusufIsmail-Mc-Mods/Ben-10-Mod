...
public class BenTenRecipeButton extends AbstractWidget {
    ...
    private BenTenRecipeBookMenu<?> menu;
    ...
    public BenTenRecipeButton() {
        super(0, 0, 25, 25, CommonComponents.EMPTY);
    }

    public void init(BenTenRecipeCollection pCollection, BenTenRecipeBookPage pRecipeBookPage) {
        this.collection = pCollection;
        this.menu = (BenTenRecipeBookMenu) pRecipeBookPage.getMinecraft().player.containerMenu;
        this.book = (BenTenClientRecipeBook) pRecipeBookPage.getRecipeBook();
    ...
    public BenTenRecipeCollection getCollection() {
