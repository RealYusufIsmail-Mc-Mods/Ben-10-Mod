...
public class HeatblastLeggingsItem extends ArmorItem implements IForgeItem {

	public HeatblastLeggingsItem(IArmorMaterial materialIn, EquipmentSlotType slot, Properties builder) {
	...
	public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
			...
			if (stack.getItem() == ItemInit.HEATBLAST_LEGGINGS.get()) {
