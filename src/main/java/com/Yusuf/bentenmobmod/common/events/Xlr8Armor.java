...
public class Xlr8Armor extends ArmorItem implements IForgeItem {
	...
	public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
		...
		if (boots.getItem() == ItemInit.XLR8_HELMET.get() && legs.getItem() == ItemInit.XLR8_CHESTPLATE.get() && chest.getItem() == ItemInit.XLR8_LEGGINGS.get() && head.getItem() == ItemInit.XLR8_BOOT.get()) {
