...
public class HeatblastArmor extends ArmorItem implements IForgeItem {
	...
	public void onArmorTick(ItemStack stack, World world, PlayerEntity player) {
		...
		if (stack.getItem() == ItemInit.HEATBLAST_CHESTPLATE.get() && stack.getItem() == ItemInit.HEATBLAST_BOOT.get() && stack.getItem() == ItemInit.HEATBLAST_HELMET.get() && stack.getItem() == ItemInit.HEATBLAST_LEGGINGS.get()) {
