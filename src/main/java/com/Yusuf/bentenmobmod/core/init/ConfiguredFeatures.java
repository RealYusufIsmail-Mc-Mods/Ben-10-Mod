...
public class ConfiguredFeatures {
	...
	public static ConfiguredFeature<?, ?> SPEED_ORE = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.SPEED_ORE.get().defaultBlockState(), 3))
            .decorated(Placement.RANGE.configured(new TopSolidRangeConfig(2, 1, 15)))
            .squared().count(3);
	public static ConfiguredFeature<?, ?> OMNITRIX_ORE = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.OMNITRIX_ORE.get().defaultBlockState(), 3))
            .decorated(Placement.RANGE.configured(new TopSolidRangeConfig(4, 1, 20)))
            .squared().count(3);
	...
	public static ConfiguredFeature<?, ?> INFINITUM_ORE = Feature.ORE.configured(new OreFeatureConfig(OreFeatureConfig.FillerBlockType.NATURAL_STONE, BlockInit.INFINITUM_ORE.get().defaultBlockState(), 3))
			.decorated(Placement.RANGE.configured(new TopSolidRangeConfig(2, 1, 20)))
			.squared().count(3);
	public static void registerConfiguredFeatures() {
		...
		Registry.register(registry, new ResourceLocation(Main.MOD_ID, "infinitum_ore"), INFINITUM_ORE);
	}
