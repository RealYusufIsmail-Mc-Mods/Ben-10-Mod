...
public class VilgaxModel<T extends Vilgax> extends EntityModel<T> {
	private final ModelRenderer Vilgax = new VilgaxModel();
	...
	public void render(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
		Vilgax.render(matrixStack, buffer, packedLight, packedOverlay);
	}
