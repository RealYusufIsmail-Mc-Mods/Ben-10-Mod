...
public class ModBlockLootTables extends BlockLootTables {
    ...
    protected void addTables() {
        ...
        add(BlockInit.DEEPSLATE_LEGENDARY_ORE_BLOCK.get(),
                createOreDrop(BlockInit.DEEPSLATE_LEGENDARY_ORE_BLOCK.get(), ItemInit.LEGENDARY_ORE.get()));
        add(BlockInit.IMPERIUM_ORE.get(),
                createOreDrop(BlockInit.IMPERIUM_ORE.get(), ItemInit.IMPERIUM.get()));
        add(BlockInit.DEEPSLATE_IMPERIUM_ORE.get(),
                createOreDrop(BlockInit.DEEPSLATE_IMPERIUM_ORE.get(), ItemInit.IMPERIUM.get()));
        ...
        add(BlockInit.DEEPSLATE_OMNITRIX_ORE.get(),
                createOreDrop(BlockInit.DEEPSLATE_OMNITRIX_ORE.get(), ItemInit.OMNITRIX.get()));
