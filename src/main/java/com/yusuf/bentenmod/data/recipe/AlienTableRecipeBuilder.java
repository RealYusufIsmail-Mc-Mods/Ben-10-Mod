...
public class AlienTableRecipeBuilder extends ShapedRecipeBuilder {
    ...
    public AlienTableRecipeBuilder(IItemProvider p_i48261_1_, int p_i48261_2_) {
        super(p_i48261_1_, p_i48261_2_);
    ...
    public void save(Consumer<IFinishedRecipe> p_200467_1_, ResourceLocation p_200467_2_) {
        ...
        p_200467_1_.accept(new AlienTableRecipeBuilder.Result(p_200467_2_, this.result, this.count, this.group == null ? "" : this.group, this.rows, this.key, this.advancement, new ResourceLocation(p_200467_2_.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + p_200467_2_.getPath())));
    }
