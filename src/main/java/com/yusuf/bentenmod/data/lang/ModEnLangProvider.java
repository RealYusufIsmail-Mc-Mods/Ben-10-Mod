...
public class ModEnLangProvider extends LanguageProvider {
    ...
    protected void addTranslations() {
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.root.description"),
                "Thank you for downloading my mod");
        // black diamond advancements
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_block.title"),
                "Made Black Diamond Block");
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_block.description"),
                "You have made a Black Diamond block using nine Black Diamond ingot.");
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_ingot.title"),
                "Made Black Diamond Ingo");
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_ingot.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_scrap.title"),
                "Mined Black Diamond and received Black Diamond scrap");
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_scrap.description"),
                "Get 3 more to be able to make an ingot to make armour and tools in smithing table.");
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_tools.title"),
                "Made all the black diamond Tools");
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_tools.description"),
                "You have made all the black diamond tool set which is better than diamond");
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_armour.title"),
                "Made all the black diamond armour set");
        add(
                new TranslationTextComponent("advancements.bentenmod.black_diamond_armour.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.legendary_block.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.knight_armour.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.legendary_ingot.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.legendary_ore.description"),
                "You just mined one of the most OP ores in the game");
        // speed advancements
        add(
                new TranslationTextComponent("advancements.bentenmod.speed_ingot.title"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.speed_block.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.xlr8_armour.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.imperium_ore.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.imperium_ingot.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.imperium_block.description"),
                "You smelted legendary ore and now you can make a sword and armour");
        add(new TranslationTextComponent("advancements.bentenmod.imperium_tools.title"), "Made all the Imperium Tools");
        add(
                new TranslationTextComponent("advancements.bentenmod.imperium_tools.description"),
                "You have made all the imperium tool set which is better than iron");
        add(
                new TranslationTextComponent("advancements.bentenmod.upgraded_imperium_pickaxe.title"),
                "Made the Upgraded Imperium Pickaxe");
        add(
                new TranslationTextComponent("advancements.bentenmod.upgraded_imperium_pickaxe.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.ruby_ore.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.ruby_block.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.ruby_apple.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.ruby_axe.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.omnitrix_ore.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.omnitrix_ingot.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.omnitrix_block.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.omnitrix_apple.description"),
                "You have a made an apple stronger than a normal golden apple");
        add(
                new TranslationTextComponent("advancements.bentenmod.enchanted_omnitrix_apple.title"),
                "You have a made an apple stronger than a normal golden apple.");
        add(
                new TranslationTextComponent("advancements.bentenmod.enchanted_omnitrix_apple.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.fire_ore.description"),
                "You just mined one of the most OP ores in the game.");
        add(new TranslationTextComponent("advancements.bentenmod.fire_ingot.title"), "Smelted Fire Ore");
        add(
                new TranslationTextComponent("advancements.bentenmod.fire_ingot.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.fire_block.description"),
                "You have crafted a fire block.");
        add(new TranslationTextComponent("advancements.bentenmod.fire_apple.title"), "Made a Fire Apple");
        add(
                new TranslationTextComponent("advancements.bentenmod.fire_apple.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.heatblast_armour.description"),
                "You are now able to fly and are resistant to fire");
        add(
                new TranslationTextComponent("advancements.bentenmod.heatblast_sword.title"),
                "you have made Heatblast sword");
        add(
                new TranslationTextComponent("advancements.bentenmod.heatblast_sword.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.copper_ingot.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.copper_block.description"),
                "You just made a copper block");
        // ininitum advancements
        add(
                new TranslationTextComponent("advancements.bentenmod.infinitum_scrap.title"),
                "Mined Infinitum and received Infinitum scrap");
        add(
                new TranslationTextComponent("advancements.bentenmod.infinitum_scrap.description"),
                "Get 3 more to be able to make an ingot to make armour and tools in smithing table.");
        add(new TranslationTextComponent("advancements.bentenmod.infinitum_ingot.title"), "Made an Infinitum Ingot");
        add(
                new TranslationTextComponent("advancements.bentenmod.infinitum_ingot.description"),
        ...
        add(
                new TranslationTextComponent("advancements.bentenmod.infinitum_block.description"),
                "You have crafted an Infinitum block.");
        add(
                new TranslationTextComponent("advancements.bentenmod.infinitum_armour.title"),
                "Made all the Infinitum armour set");
        add(
                new TranslationTextComponent("advancements.bentenmod.infinitum_armour.description"),
                "You have made all the Infinitum armour set which is better than Black diamond and netherite.");
        add(
                new TranslationTextComponent("advancements.bentenmod.infinitum_tools.title"),
                "Made all the Infinitum Tools");
        add(
                new TranslationTextComponent("advancements.bentenmod.infinitum_tools.description"),
