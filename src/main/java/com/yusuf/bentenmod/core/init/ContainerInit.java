...
import com.yusuf.bentenmod.core.machine.testtable.TestContainer;
...
public class ContainerInit {
    ...
    public static final RegistryObject<ContainerType<TestContainer>> TEST_CONTAINER = CONTAINERS.register("test", () -> IForgeContainerType.create(TestContainer::new));
